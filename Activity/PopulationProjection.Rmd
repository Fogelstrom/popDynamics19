...
We are now going to try different methods of predicting the future growth of populations and of estimating the (long term) growth rate, $\lambda$.  
  
First, you will need to install the package `popbio`:
In RStudio: `Tools/Install packages` ...   
In R console: `install.packages("popbio")`  

We will project a population of the common frog *Rana temporaria* into the future. 
